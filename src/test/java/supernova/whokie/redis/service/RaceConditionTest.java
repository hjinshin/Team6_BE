...
//            executorService.submit(() -> {
//                try {
//                    rankingWriterService.increaseRankingCountByUserAndQuestionAndGroups(user.getId(), "test", group);
//                } catch (Exception e) {
//                    e.printStackTrace();
//                } finally {
//                    latch.countDown();
...
//
//        // then
//        Ranking actual = rankingRepository.findByUserIdAndQuestionAndGroups(user.getId(), "test", group)
//            .orElseThrow();
//
//        assertAll(
